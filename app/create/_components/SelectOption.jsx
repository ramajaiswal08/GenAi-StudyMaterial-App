...
function SelectOption({selectedStudyType}) {
  ...
  return (
    <div>
        ...
        <div className=' grid grid-cols-2 md:grid-cols-3 mt-5 lg:grid-cols-5 gap-5'>
            {Options.map((option,index)=> (
                <div key={index} className={`flex flex-col p-4 items-center justify-center
                 border rounded-xl gap-5 hover:border-primary cursor-pointer
